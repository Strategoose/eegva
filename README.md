...
1. Add the path to the new raw data to control-script.R. You can simply copy and paste a duplicate of the existing code chunk below, updating the file paths and the year.
